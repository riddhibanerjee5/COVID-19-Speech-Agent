...
public class MicrophoneCapture : MonoBehaviour
{
    ...
    **/
    const string PROJECT_ID = "nuia3-384003";
    const string email = "unity-728@nuia3-384003.iam.gserviceaccount.com";
    /* Make sure it is in the Assets Folder so that this is only the name */
    string certPath = "nuia3-384003-2d6ee78a18d0.p12";

    // This needs to be changed to access you script
    public ChadBehaviors myScript;
    ...
    void Start()
    {
        ...
        this.myScript = GameObject.FindObjectOfType(typeof(ChadBehaviors)) as ChadBehaviors;
